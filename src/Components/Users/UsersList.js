...
export default function UsersList(props) {
    ...
    const getUserDetails = () => {
        const url = "https://61443d72411c860017d25360.mockapi.io/usersdata/api/v1/users";
        fetch(url)
            .then((data) => (data.json()))
    ...
    const deleteUser = (id) => {
        axios.delete(`https://61443d72411c860017d25360.mockapi.io/usersdata/api/v1/users/${id}`)
        .then((response) => {
